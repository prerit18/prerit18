...
![Claude](https://img.shields.io/badge/Claude_Sonnet-7C3AED?style=flat)
![OpenAI](https://img.shields.io/badge/OpenAI_Agents_SDK-412991?style=flat&logo=openai&logoColor=white)
![Opik](https://img.shields.io/badge/Opik_LLM_Observability-00B4D8?style=flat)

**AI / ML Engineering**
![Sagemaker](https://img.shields.io/badge/AWS_Sagemaker-FF9900?style=flat&logo=amazonaws&logoColor=white)
![PyTorch](https://img.shields.io/badge/PyTorch-EE4C2C?style=flat&logo=pytorch&logoColor=white)
![Feature Store](https://img.shields.io/badge/AWS_Feature_Store-FF9900?style=flat&logo=amazonaws&logoColor=white)
...
![Java](https://img.shields.io/badge/Java_Springboot-6DB33F?style=flat&logo=springboot&logoColor=white)
...
|---|---|---|
| [**AI-Bank**](https://github.com/prerit18/AI-Bank) | Full-stack banking app with production-grade fraud analytics engine, rule builder UI and fraud analyst portal | FastAPI · Next.js · Redis · Python |
| [**PM_agentic**](https://github.com/prerit18/PM_agentic) | Multi-agent deep research system: planner → parallel web search → LLM writer → email delivery | OpenAI Agents SDK · Python · asyncio |
| [**awsmlpmproj3**](https://github.com/prerit18/awsmlpmproj3) | CNN image classification on SageMaker with HPO, Debugger, Profiler and deployed inference endpoint | PyTorch · SageMaker · Step Functions |
| [**udap3**](https://github.com/prerit18/udap3) | Full blue/green CI/CD auto-deploy pipeline with IaC, config management and Prometheus monitoring | CircleCI · CloudFormation · Ansible |
